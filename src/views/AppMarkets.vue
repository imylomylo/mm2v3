    ...
    <div>
      <v-row>
        <v-col class="text-center" cols="12" sm="4">
          <template v-if="newmarket.rel !== 0">
            <v-btn width="256" depressed color="primary" outlined @click="gotoMarketView(newmarket.base.ticker, newmarket.rel.ticker)">
              Go to market {{ newmarket.base.ticker }} / {{ newmarket.rel.ticker }}
            </v-btn>
          </template>
        </v-col>
      </v-row>
      <v-row align="center">
        <v-col class="text-center" cols="12" sm="4">
          BASE COIN (e.g. KMD)
          <div v-for="coin in activeCoins" :key="coin.id">
            <div class="my-2">
