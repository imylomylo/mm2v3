...
export default {
  ...
  methods: {
    showCEXMarket: function(base, rel) {
      ...
      axios
        .get(
          "http://" + process.env.VITE_VUE_APP_WEBHOST + ":7780/getbinancemarketprice?base=" +
            base +
            "&rel=BTC"
        )
        .then(response => {
    ...
    showBITTREXMarket: function(base, rel) {
      ...
      axios
        .get(
          "http://" + process.env.VITE_VUE_APP_WEBHOST + ":7780/getbittrexmarketprice?base=" +
            base +
            "&rel=BTC"
        )
        .then(response => {
  ...
  created: function() {
    ...
    axios
      .get("http://" + process.env.VITE_VUE_APP_WEBHOST + ":7780/coinsenabled")
      .then(response => {
        // console.log(response.data);
